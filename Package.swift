...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Notifications-2.1.0-beta.23.xcframework.zip",
			checksum: "c652abe94d12b55bed246614a228aaa3d01e08ef81799ac18dd80c5cb4d4f536"
		)
	]
)