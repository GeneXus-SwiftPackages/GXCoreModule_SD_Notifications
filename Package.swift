...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Notifications-1.2.0-rc.15.xcframework.zip",
			checksum: "cb9a838123528213fd274dd3e3940c937a90196b445d5fcd182b800b20597515"
		)
	]
)