...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-4.0.17.xcframework.zip",
			checksum: "66469e1b0237c46451b81f75c5c5ccfff8b658c88219d73fa8065ea9686fcfbb"
		)
	]
)