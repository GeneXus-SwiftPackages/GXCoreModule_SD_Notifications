...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Notifications-2.0.0-beta.39.xcframework.zip",
			checksum: "4ce44d6e5e00491bf52b00f2ecb16a59b17017af42c7ca4b9329798badf287e3"
		)
	]
)