...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-2.1.0.xcframework.zip",
			checksum: "136e7aa3ef73b6c982398a980c2c04733f3ba0878a209db34dbdfb461e798683"
		)
	]
)