...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-1.4.27.xcframework.zip",
			checksum: "1fd427d454d9a2d40c5a3712b26fdae1f3c6f6e24ba033954eef0a1ac7cee17e"
		)
	]
)