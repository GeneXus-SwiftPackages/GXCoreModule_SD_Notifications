...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-3.1.4.xcframework.zip",
			checksum: "b854db50e7d115224d5ce08694ac62eb969ee56ae8034d835482b732716eb43b"
		)
	]
)