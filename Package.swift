...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Notifications-1.5.0-beta.20.xcframework.zip",
			checksum: "b12b8739ffc55cc0504dbbc268f57077db3589ab6128146178f5892b448d4359"
		)
	]
)