...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-1.3.5.xcframework.zip",
			checksum: "75f0d42bc2e4a4f72a7ab0f1bada1290a62700650482e42c488c099a18130cc9"
		)
	]
)