...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-1.5.16.xcframework.zip",
			checksum: "25d7874955f58ae0001a9568731d3aadceffb1c74751b9e0bc611cc8776dfcd3"
		)
	]
)