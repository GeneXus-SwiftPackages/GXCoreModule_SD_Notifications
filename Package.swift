...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-1.3.6.xcframework.zip",
			checksum: "01cec4ecc28889e3ad8761613e469d8715850b80e8b1835974df26c6c1c23b28"
		)
	]
)