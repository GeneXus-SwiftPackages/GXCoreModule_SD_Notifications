...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-2.0.18.xcframework.zip",
			checksum: "98fbf21ce0319a349059a21360b664120ac98f2e176fc2287719a5bd5e917ddb"
		)
	]
)