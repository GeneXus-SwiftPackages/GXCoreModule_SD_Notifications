...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-1.5.11.xcframework.zip",
			checksum: "4df9d014afd82d64eb40c9555198bdc246a87727e92e6338ad4065f7eb1d22a1"
		)
	]
)