...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-3.0.2.xcframework.zip",
			checksum: "9143531a9151ad9602c4002bc6bc8b274700f58a8c307bb526ebe847690c0839"
		)
	]
)