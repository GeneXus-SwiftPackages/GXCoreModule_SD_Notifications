...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-3.0.7.xcframework.zip",
			checksum: "acdb82eb7191952247314968207a24ba0d433e9741833aa7f7bb60cd2aed7d09"
		)
	]
)