...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-3.0.4.xcframework.zip",
			checksum: "bff8946b9274dd1268751a87bdeb642c968fde00fc325221d5e2dc49865d64c1"
		)
	]
)