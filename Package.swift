...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-1.1.0-rc.1.xcframework.zip",
			checksum: "bbf5a9b88b5ce6efaa0f7286802609b0a72ba121153d38dd1e4873bfa1bb55e1"
		)
	]
)