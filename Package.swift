...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Notifications-2.0.0-rc.22.xcframework.zip",
			checksum: "18a3f8b7027257359a67e65d8ca4c8334309ba0a589a00ebfc8691a66f7213dd"
		)
	]
)