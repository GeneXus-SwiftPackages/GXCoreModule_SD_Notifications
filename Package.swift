...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-4.0.5.xcframework.zip",
			checksum: "44473d7e83a88d1db66050b9ffd33741f275104b1f13d86b22fb43e35a55cfaf"
		)
	]
)