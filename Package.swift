...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Notifications-1.2.0-beta.33.xcframework.zip",
			checksum: "c355a797cbbe87c66bf9ea970ad345870c1c90d0a25ea9e4ac11f2b7ef07be20"
		)
	]
)