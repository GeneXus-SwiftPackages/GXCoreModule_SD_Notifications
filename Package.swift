...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Notifications-1.2.0-beta.34.xcframework.zip",
			checksum: "1be6f92b7b88c3a4cdba9ccc4c3d2c0726d0dee71e3efb3d62c7816b54c5f901"
		)
	]
)