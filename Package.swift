...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Notifications-1.5.0-beta.21.xcframework.zip",
			checksum: "5360931fa809cb60822956e5d9dfc98cedf9c406c3b99fe5856d8e9631f3ddb0"
		)
	]
)