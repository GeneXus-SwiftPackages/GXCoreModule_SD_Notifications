...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Notifications-1.2.0-beta.1.xcframework.zip",
			checksum: "5910af7088e8ca1321590165468a3ec2ff05a6d21c82036aaeccf49e4f806350"
		)
	]
)