...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-4.2.0.xcframework.zip",
			checksum: "d574940b82f65c0c7213abc8e9de5cfb53be40205805ae72313e6500df13244b"
		)
	]
)