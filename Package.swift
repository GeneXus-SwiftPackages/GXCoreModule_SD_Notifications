...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Notifications-3.2.0-beta.22.xcframework.zip",
			checksum: "13607f35ef3359fc6e61b5a5d4b74ad527ec3b73a7ffb579c979a90430b5bc6f"
		)
	]
)