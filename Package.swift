...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-2.1.3.xcframework.zip",
			checksum: "4e1643f495f5a5286b4eb3dff0302531d82871b122186cfae78328aca8659554"
		)
	]
)