...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Notifications-1.5.0-beta.10.xcframework.zip",
			checksum: "3f7a2d68a3bab9ecee4589a253e4a19a31ff03bdb431a848edbf162b787a4f46"
		)
	]
)