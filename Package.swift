...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Notifications-1.1.0-beta.9.xcframework.zip",
			checksum: "92085f2801a3d9acc02be8fb86b710836c9e678714d95b6aef4b700029c075f3"
		)
	]
)