...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Notifications-1.1.0-beta.794.xcframework.zip",
			checksum: "ede7cb305be846bfab6503646882a5a9f5bac7cc68a54f68c3cbee6281b9709a"
		)
	]
)