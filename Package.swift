...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Notifications-1.2.0-beta.32.xcframework.zip",
			checksum: "d6fc4c21f71ce65687f9e9a066807aaddb9e367f4d0f6266ef993b3ab3d0e301"
		)
	]
)