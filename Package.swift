...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Notifications-1.6.0-beta.2.xcframework.zip",
			checksum: "5fe9e913f0f0738d27cf5be3433d416e0d3922e20681d39134efdc9ce9d1a0f8"
		)
	]
)