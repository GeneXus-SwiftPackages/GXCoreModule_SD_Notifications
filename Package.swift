...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Notifications-2.0.0-beta.22.xcframework.zip",
			checksum: "e2fbf27efc9b3ccdf41890628b0d7f8f741cb20ce1b5001f90631427a79a8316"
		)
	]
)