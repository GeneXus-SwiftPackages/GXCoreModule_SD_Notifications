...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-1.4.30.xcframework.zip",
			checksum: "385db7277abae936ea190fb17cb8d93859b4e34156884f0d7bae8bab16db1e0b"
		)
	]
)