...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-4.0.0.xcframework.zip",
			checksum: "07dba16eb463c3b40626622dbdb4b7fa9b81e0df2f73dbfb1a0ee03a9aedc49a"
		)
	]
)