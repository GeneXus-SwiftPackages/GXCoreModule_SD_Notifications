...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Notifications-1.4.0-rc.21.xcframework.zip",
			checksum: "986e646e3489562f31a8941f708141db8bc563ac4b0b2ea09101a51a049039b0"
		)
	]
)