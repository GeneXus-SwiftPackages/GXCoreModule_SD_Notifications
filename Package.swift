...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Notifications-4.1.0-beta.18.xcframework.zip",
			checksum: "1de819273ac374ee7c6402934893a5abdbb49987393f84348a3be9c02a0251a4"
		)
	]
)