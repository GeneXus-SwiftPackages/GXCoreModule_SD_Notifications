...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-2.0.17.xcframework.zip",
			checksum: "58d49ed3d9f84f3c49e5a20dc8308815de754928e02b797579b3577016fea143"
		)
	]
)