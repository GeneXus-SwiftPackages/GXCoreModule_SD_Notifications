...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-3.0.1.xcframework.zip",
			checksum: "e08cfe141e7a8e4e395baf09d2d913ef988348f42acf0f31bb3f246172f99863"
		)
	]
)