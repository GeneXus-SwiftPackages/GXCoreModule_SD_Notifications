...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Notifications-1.5.0-beta.13.xcframework.zip",
			checksum: "51e1438b61de37d2384e4b6b95ab4fc8ebab3bac0b796fa0e8e6daebccd79cc0"
		)
	]
)