...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-4.0.8.xcframework.zip",
			checksum: "bcd6df5c8cf4bd75f3899c8f285353046a614a63da6f252b0074be75684aab95"
		)
	]
)