...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Notifications-1.1.0-beta.12.xcframework.zip",
			checksum: "c0a10eef6711a3cb28b566ff076c0dfcf9a58c63efbf14b6ce1c90ade8691ae5"
		)
	]
)