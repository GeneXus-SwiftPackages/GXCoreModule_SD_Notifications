...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-1.5.17.xcframework.zip",
			checksum: "69d6c780297cd6e6a96ff6f2bf9f100afaf43ab4530fe18611839f0691a55831"
		)
	]
)