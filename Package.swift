...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-4.0.6.xcframework.zip",
			checksum: "1e3fa3ab3d02ab861a1faa74297028875d6eef1d7fa55ac2c2dc71e9a815d2b6"
		)
	]
)