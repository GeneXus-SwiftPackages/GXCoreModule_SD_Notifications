...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Notifications-1.6.0-rc.0.xcframework.zip",
			checksum: "5b016a239eef7e829af651f37f16866674d3ee66ab635c19ce7589f753564e8d"
		)
	]
)