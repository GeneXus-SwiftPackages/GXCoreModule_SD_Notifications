...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-4.1.2.xcframework.zip",
			checksum: "bfc02bc5256e9a919060d37fb378d70c3ff2b340522946eb946bb411d120595e"
		)
	]
)