...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-1.4.29.xcframework.zip",
			checksum: "63f0a15d2046913040a9fef85798e95a23bab47d2e480d90e4e9984ac36fb08c"
		)
	]
)