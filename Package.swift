...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Notifications-3.2.0-beta.23.xcframework.zip",
			checksum: "8f2ec6c1130785f493c6f104039554f6f79376a53c0c39af473037eda2f7d78a"
		)
	]
)