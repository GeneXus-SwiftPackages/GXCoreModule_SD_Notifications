...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Notifications-4.1.0-beta.13.xcframework.zip",
			checksum: "701b0127ef21eb7be80b2610cc3fefa40565cec6ee9f1b43c3824b468f1fd6f0"
		)
	]
)