...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-3.2.0.xcframework.zip",
			checksum: "866143d081936838da8e2d95ce65a745a06cbec87687af8f8b498fd8ab406b16"
		)
	]
)