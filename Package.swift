...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-3.1.0.xcframework.zip",
			checksum: "2a0e4b5adf1a02e737a70825dddae91ac752de81a11de6cb57c256b92f03c56f"
		)
	]
)