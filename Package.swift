...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Notifications-2.0.0-rc.36.xcframework.zip",
			checksum: "eff096ad07c9fbf72cbe709b75cc2461237160ffe5ebdb53bc14562f9f0cc7cc"
		)
	]
)