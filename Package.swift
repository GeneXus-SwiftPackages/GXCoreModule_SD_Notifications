...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-1.2.0.xcframework.zip",
			checksum: "b4554a4e803a5e4e6655ac20a92fda3b4c0735c13c2ca232ef16d94b5b7e0f7a"
		)
	]
)