...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Notifications-1.4.0-beta.5.xcframework.zip",
			checksum: "5da1ee37078325e8fb4426c7bad1968d27f59592f3b5b8da42a045d26c86532b"
		)
	]
)