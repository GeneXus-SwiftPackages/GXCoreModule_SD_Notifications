...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Notifications-1.4.0-beta.6.xcframework.zip",
			checksum: "f0562f83823b12a174ffee9ae51ec9345327c55b2dfc51394761eb5c01a85973"
		)
	]
)