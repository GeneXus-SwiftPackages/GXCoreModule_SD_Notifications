...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-1.1.2.xcframework.zip",
			checksum: "fbe3e68b5d9212dbc57593fb9666145bb76777498a039bf27c42a53a9256af95"
		)
	]
)