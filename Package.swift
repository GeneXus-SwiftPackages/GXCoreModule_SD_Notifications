...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-4.0.16.xcframework.zip",
			checksum: "b78aa3627dfd26582b85d2bfbaf1dfb79b460e3d11738223c90478ccb8a8d6ba"
		)
	]
)