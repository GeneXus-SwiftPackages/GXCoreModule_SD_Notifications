...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-4.0.7.xcframework.zip",
			checksum: "e1cc866c84ee83eb8e13b971e785936ef3e1fad22e61deb2dbcc0d1c19a9c2a5"
		)
	]
)