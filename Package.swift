...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Notifications-3.0.0-beta.13.xcframework.zip",
			checksum: "c6a4da89e91e446e93365cfe74f98905a37f6c28881afb220aa6f61409ddb61f"
		)
	]
)