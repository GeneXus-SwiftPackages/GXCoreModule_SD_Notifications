...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-4.1.0.xcframework.zip",
			checksum: "e51de8a1913e1898406353902c005db72dd106d8f51169eb18ab5eff5b0f5fb5"
		)
	]
)