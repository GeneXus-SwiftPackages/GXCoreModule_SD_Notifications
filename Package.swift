...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Notifications-1.3.0-beta.7.xcframework.zip",
			checksum: "384c2ac2cdec372040b45e6cec2b6209a707e18a3d2d1a401d819832d04cb3df"
		)
	]
)