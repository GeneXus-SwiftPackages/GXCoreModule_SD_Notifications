...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-4.1.5.xcframework.zip",
			checksum: "013dbbde01cae5034997687a847a4ceabdd2b0332a9a102e52fbedb8d53ba0d6"
		)
	]
)