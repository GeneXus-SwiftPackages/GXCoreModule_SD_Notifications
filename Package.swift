...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Notifications-1.1.0-rc.3.xcframework.zip",
			checksum: "bf2ab552bcdc3c9c9f5be322f962ce3b3c8d965dfc4bb159b7d7f860131ce695"
		)
	]
)