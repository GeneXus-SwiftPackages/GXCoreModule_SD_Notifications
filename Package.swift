...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Notifications-1.0.0-beta.20230617144628.xcframework.zip",
			checksum: "22010ecae505eecc5d0158ce230cf2a67fa6b68567bfd8782b220b2fbc7a747a"
		)
	]
)