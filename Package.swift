...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-1.5.12.xcframework.zip",
			checksum: "f7448100c8c02f08767568a5668d026532a7ce3e9f87cbc6b3d9539081d95816"
		)
	]
)