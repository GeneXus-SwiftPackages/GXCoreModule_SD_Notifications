...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Notifications-2.2.0-beta.25.xcframework.zip",
			checksum: "10266e5625b7433ffd02243b2241dfff49f12c4bf5bb5cf1c4311709c980a72c"
		)
	]
)