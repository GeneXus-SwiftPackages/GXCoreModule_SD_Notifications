...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-2.0.12.xcframework.zip",
			checksum: "b870cd290f909d1f848200769284af14f3fa0db550018ea7fc6b5acf574eb60b"
		)
	]
)