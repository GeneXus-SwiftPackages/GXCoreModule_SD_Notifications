...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Notifications",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Notifications-3.0.3.xcframework.zip",
			checksum: "c0b14c2a265ddb0537dadd5043a6f76ce7ee199e2e06f60800e6fbf7139b60a1"
		)
	]
)